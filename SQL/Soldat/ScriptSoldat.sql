...
ALTER TABLE Soldats ADD CONSTRAINT Soldats_Unite0_FK FOREIGN KEY (idUnite) REFERENCES Unite(idUnite);
ALTER TABLE Produit ADD CONSTRAINT Produit_Blessures_FK FOREIGN KEY (idBlessure) REFERENCES Blessures(idBlessure);
ALTER TABLE Produit ADD CONSTRAINT Produit_Bataille0_FK FOREIGN KEY (idBataille) REFERENCES Bataille(idBataille);
ALTER TABLE Subi ADD CONSTRAINT Subi_Soldats_FK FOREIGN KEY (idSoldat) REFERENCES Soldats(idSoldat);
ALTER TABLE Subi ADD CONSTRAINT Subi_Blessures0_FK FOREIGN KEY (idBlessure) REFERENCES Blessures(idBlessure);