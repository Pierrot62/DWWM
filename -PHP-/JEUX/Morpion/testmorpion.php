...
function conversionPosition($coordonnee)
{
    ...
    if (ctype_alpha($coordonnee[0])) //La lettre est en premier
    {
        ...
        {
            $chiffre = 10 * $coordonnee[1]; // on transforme [1,5] en 15
        }
        else
        {
...
{
    do{
    $jeu = strtoupper(readline("A quelle jeu voulez vous jouer ? MORPION ( M ) PUISSANCE 4 ( p )  : "));
    echo $jeu;
    }while(($jeu <> "M") || ($jeu <> "P"));
    //msg de bienvenue
