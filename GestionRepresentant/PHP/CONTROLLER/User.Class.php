...
class User 
{
	...
	*/
	...
	{
		return "IdUser : ".$this->getIdUser()."NomUser : ".$this->getNomUser()."PrenomUser : ".$this->getPrenomUser()."MdpUser : ".$this->getMdpUser()."RoleUser : ".$this->getRoleUser()."PseudoUser : ".$this->getPseudoUser()."\n";
	}
