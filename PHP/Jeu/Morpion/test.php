...
function lancerPartie()
{
    ...
    do
    {
        ...
        $positions = selectionPosition($plateau);
        $plateau = remplirTableau($plateau, $symboles, $positions);
        $testGagner = testerGagne($plateau, $alignementPourGagner, $positions, $symboles);
    } while ($testGagner == 0);
    if ($testGagner==1)
    {
        echo "Le joueur $joueurEnCours a gagné";
    }
    else{
