...
$newObj = new Stagiaires(["genreStagiaire" => "([value 1])", "nomStagiaire" => "([value 2])", "prenomStagiaire" => "([value 3])", "numSecuStagiaire" => "([value 4])", "numBenefStagiaire" => "([value 5])", "emailStagiaire" => "([value 6])", "dateNaissanceStagiaire" => "([value 7])"]);
