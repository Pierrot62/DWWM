...
class Valeurshoraires 
{
	...
	public function getIdValeurHoraire()
	{
		return $this->_idValeurHoraire;
	}

	public function setIdValeurHoraire($idValeurHoraire)
	{
		$this->_idValeurHoraire=$idValeurHoraire;
	}
	...
	*/
	...
	{
		return "IdValeurHoraire : ".$this->getIdValeurHoraire()."IdStage : ".$this->getIdStage()."IdLibelleHoraire : ".$this->getIdLibelleHoraire()."ValeurHoraire : ".$this->getValeurHoraire()."\n";
	}
